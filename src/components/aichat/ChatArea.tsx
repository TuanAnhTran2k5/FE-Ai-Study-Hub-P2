  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-transparent">
      ...
      <div className="shrink-0 flex items-center justify-between pb-6 pt-2 px-2">
        ...
        <div className="flex items-center gap-3">
          <Button variant="ghost" className="text-sm cursor-pointer font-semibold rounded-full bg-white/50 hover:bg-white text-primary shadow-sm border border-border/50">
            <PlusCircle className="mr-2 size-4" />
            New Chat
          </Button>
          <Button variant="ghost" className="text-sm font-semibold cursor-pointer rounded-full bg-white/50 hover:bg-white text-destructive hover:text-destructive shadow-sm border border-destructive/20">
